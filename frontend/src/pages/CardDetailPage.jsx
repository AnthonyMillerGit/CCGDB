      ...
      <div className="flex flex-col md:flex-row gap-8 mb-12">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-1 mb-1">
            ...
            <ManaCost cost={attrs.mana_cost} />
          </div>

          {/* Type line */}
          <p className="text-gray-400 text-lg mb-4">{card.card_type}</p>
          ...
          {keywords.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-4">
              {keywords.map(kw => (
                <span
                  key={kw}
                  className="bg-indigo-900 border border-indigo-700 text-indigo-300 text-sm px-3 py-1 rounded-full"
                >
                  {kw}
                </span>
              ))}
